...
if os.path.exists(results_path):
    ...
    df = pd.DataFrame(columns=["data_name", "prerank", "pce", "energy"])
...
for data_group, data_name in datasets:
    ...
    for prerank in preranks:
        ...
        for x, y, _ in test_loader:
            ...
            # nll_value = -base_dist.log_prob(y).mean() #will be the same for all preranks since it doesn't depend on prerank at all
