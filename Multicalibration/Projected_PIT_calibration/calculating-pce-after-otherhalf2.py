...
tuning_all = pd.read_csv("tuning-results-double-reg-otherhalf2.csv")
best_lambdas_all = {}
...
results_path = "metrics-after-reg-double-reg-otherhalf2.csv"
...
for data_group, data_name in datasets:
    for prerank in preranks:
        for seed in seeds:
            ...
            model = MixtureLightningModule(p, q, lambda_reg=hparams['lambda'], reg_type = 'pce-kde', prerank=hparams['prerank'], double_reg = True)
